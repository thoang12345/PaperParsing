![Image](/home/thienan/Documents/Github/PaperParsing/Docling Parsing/v0.2/Output/docling/doclingOCR/2408.09869v5/image_000000_7230d02ad5533ee42d9a842d2bcdb3c1a27348853e07511f920c8ec700449558.png)
...
![Image](/home/thienan/Documents/Github/PaperParsing/Docling Parsing/v0.2/Output/docling/doclingOCR/2408.09869v5/image_000001_9a983e23f10642fa9b46635081f8ff792cec83c6cc5a26db67427824d7ee3fec.png)

Picture description:
The figure is a flowchart that illustrates a model pipeline for processing PDF documents. It starts with the input of PDF pages, which are then parsed to extract text and images. The extracted data is then subjected to various stages of analysis, including Optical Character Recognition (OCR), Layout Analysis, and Table Structure. The results of these analyses are assembled and post-processed. Finally, the processed data is serialized as JSON or Markdown. The flowchart uses arrows to indicate the direction of the process, and each stage is represented by a specific icon. The diagram is designed to be clear and easy to understand, with labels and a legend that explain the different stages of the pipeline. The main components of the figure are the input, processing stages, and output, which are interconnected by the arrows. The figure is a visual representation of a workflow that can be used to understand the steps involved in processing PDF documents.
...
| (16 cores)              | 4               | 375 s 244 s      | 0.60 0.92        | 6.16 GB          | 239 s 143 s        | 0.94 1.57          | 2.42 GB            |
...
![Image](/home/thienan/Documents/Github/PaperParsing/Docling Parsing/v0.2/Output/docling/doclingOCR/2408.09869v5/image_000002_443881179f0631824e9c24284c048f4a14add1111f4a4895cb81df834ed8d753.png)

Picture description: The image is a page from a research paper titled "DocLayNet: A Large Human-Annotated Dataset for Document-Layout Analysis." It is divided into two main sections: the left side contains a list of authors and their affiliations, while the right side features a title, abstract, and a figure caption. The figure caption describes a series of four images, each depicting a different aspect of document layout analysis. The images are arranged in a grid with two rows and two columns. The top left image shows a close-up of a text box with a checkmark, indicating a positive outcome. The top right image displays a text box with a cross, suggesting a negative outcome. The bottom left image features a text box with a question mark, implying uncertainty or a need for further investigation. The bottom right image presents a text box with a lightbulb, symbolizing an idea or a solution. The images are accompanied by a brief description of
...
![Image](/home/thienan/Documents/Github/PaperParsing/Docling Parsing/v0.2/Output/docling/doclingOCR/2408.09869v5/image_000003_f73e9b5fe95843d0529c53394ff573348e20489e9f281d78e0a886297d7602fa.png)

Picture description: The figure is a line graph titled "Figure 3: Prediction performance in AP@100 of Mask R-CNN on the COCO-2017 dataset." It shows the performance of Mask R-CNN, a deep learning model for object detection, on the COCO-2017 dataset. The x-axis represents the number of training iterations, and the y-axis represents the AP@100 score, which is a measure of the model's performance. The graph shows a clear trend of improvement in performance as the number of training iterations increases. The model's performance is evaluated using the COCO-2017 dataset, which is a large-scale dataset for object detection and segmentation. The graph is a useful visualization of the model's performance and can be used to compare the performance of different models or to evaluate the effectiveness of different training strategies.
...
![Image](/home/thienan/Documents/Github/PaperParsing/Docling Parsing/v0.2/Output/docling/doclingOCR/2408.09869v5/image_000004_1c099d6090b9c9c69e1371b7f0ade1e14050bbbf49188137bc39ed47897eeaa2.png)

Picture description: The image is a split-screen display of two tables. On the left, labeled "A," there is a table with a header row and multiple rows of data. The table has columns labeled "Class label," "Count," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "All," "True," "False," "
